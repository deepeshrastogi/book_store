...
import { SET_USER_TOKEN_GETTER,GET_BOOKS_ACTION,LOADING_SPINNER_SHOW_MUTATION,SET_BOOKS_DATA_GETTER } from "@/store/storeConstants";
...
export default {
    ...
    computed: {
        ...
        ...mapGetters('books',{
            books:(state) => state.SET_BOOKS_DATA_GETTER.books,
            tableVisibility:(state) => state.SET_BOOKS_DATA_GETTER.tableVisibility,
            pagination:(state) => state.SET_BOOKS_DATA_GETTER.pagination,
        }),
    },
    created(){
