<x-app-layout>
    @section('title')
    {{ config('app.name', 'Laravel') }} | Books | Add new book
    @endsection
    <div class="container">
        <h3 class="mt-4 mb-2">Add New Book</h3>
                ...
                <form method="POST" action="{{ route('book.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputAuthor" type="text" name="author" value="{{ old('author') }}" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputGenre" type="text" name="genre" value="{{ old('genre') }}" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputIsbn" type="number" name="isbn" value="{{ old('isbn') }}" />
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputPublished" type="date" name="published" value="{{ old('published',date('Y-m-d')) }}" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputPublisher" type="text" name="publisher" value="{{ old('publisher') }}" />
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="inputDescription" type="text" name="description">{{ old('description') }}</textarea>
